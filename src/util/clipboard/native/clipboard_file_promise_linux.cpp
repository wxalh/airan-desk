                                   ...
                                   QString *errorMessage)
{
    ...
    if (errorMessage)
    {
        *errorMessage = QCoreApplication::translate(
            "ClipboardFilePromise",
            "Linux does not have a universal native clipboard file-promise backend; using cache-first fallback.");
    }
    return false;
}
                                     ...
                                     QString *errorMessage)
{
    ...
    if (errorMessage)
    {
        *errorMessage = QCoreApplication::translate(
            "ClipboardFilePromise",
            "Linux does not have a universal native file-promise drag backend.");
    }
    return false;
}
