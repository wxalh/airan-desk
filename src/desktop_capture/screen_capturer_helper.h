...
#ifndef AIRAN_DESKTOP_CAPTURE_SCREEN_CAPTURER_HELPER_H_
#define AIRAN_DESKTOP_CAPTURE_SCREEN_CAPTURER_HELPER_H_
...
#endif  // AIRAN_DESKTOP_CAPTURE_SCREEN_CAPTURER_HELPER_H_
