...
std::unique_ptr<DesktopCapturer> DesktopCapturer::CreateRawScreenCapturer(
  ...
  if (options.allow_sck_capturer()) {
    ...
    if (sck_capturer) {
      LOG_INFO("video capture: DesktopCapturer::CreateRawScreenCapturer creates DesktopCapturer of type ScreenCapturerSck");
      return sck_capturer;
    }
  }

  LOG_INFO("video capture: DesktopCapturer::CreateRawScreenCapturer creates DesktopCapturer of type ScreenCapturerMac");
  auto capturer =
