...
#include "desktop_capture/win/window_capturer_win_gdi.h"
...
std::unique_ptr<DesktopCapturer> DesktopCapturer::CreateRawWindowCapturer(
  ...
  LOG_INFO("DesktopCapturer::CreateRawWindowCapturer creates DesktopCapturer of type WindowCapturerWinGdi");
  ...
  if (options.allow_wgc_capturer_fallback() &&
    ...
    // WGC.
    LOG_INFO("DesktopCapturer::CreateRawWindowCapturer creates DesktopCapturer of type FallbackDesktopCapturerWrapper which has a fallback capturer of type WgcCapturerWin");
