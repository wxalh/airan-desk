...
#ifndef AIRAN_DESKTOP_CAPTURE_FULL_SCREEN_APPLICATION_HANDLER_H_
#define AIRAN_DESKTOP_CAPTURE_FULL_SCREEN_APPLICATION_HANDLER_H_
...
#endif  // AIRAN_DESKTOP_CAPTURE_FULL_SCREEN_APPLICATION_HANDLER_H_
