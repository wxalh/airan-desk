...
#include "desktop_capture/window_finder_mac.h"
  ...
  if (full_screen_window_detector_) {
    full_screen_window_detector_->UpdateWindowListIfNeeded(
        window_id_, [](DesktopCapturer::SourceList* sources) {
          // Not using GetWindowList(sources, true, false)
...
std::unique_ptr<DesktopCapturer> DesktopCapturer::CreateRawWindowCapturer(
  ...
  LOG_INFO("video capture: DesktopCapturer::CreateRawWindowCapturer creates DesktopCapturer of type WindowCapturerMac");
