...
#ifndef AIRAN_DESKTOP_CAPTURE_LINUX_X11_SHARED_X_DISPLAY_H_
#define AIRAN_DESKTOP_CAPTURE_LINUX_X11_SHARED_X_DISPLAY_H_
...
#endif  // AIRAN_DESKTOP_CAPTURE_LINUX_X11_SHARED_X_DISPLAY_H_
