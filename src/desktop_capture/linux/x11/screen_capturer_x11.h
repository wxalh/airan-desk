...
#ifndef AIRAN_DESKTOP_CAPTURE_LINUX_X11_SCREEN_CAPTURER_X11_H_
#define AIRAN_DESKTOP_CAPTURE_LINUX_X11_SCREEN_CAPTURER_X11_H_
...
#include "desktop_capture/linux/x11/shared_x_display.h"
#include "desktop_capture/linux/x11/x_atom_cache.h"
...
class ScreenCapturerX11 : public DesktopCapturer,
 ...
 public:
  ...
  // TODO(ajwong): Do we really want this to be synchronousNone
 ...
 private:
  ...
  // selected_monitor_name_ is set by SelectSource() at the end of Init().
  // Airan maps kFullDesktopScreenId to one concrete XRandR monitor instead of
  // exposing the root window as a composed multi-monitor source.
...
#endif  // AIRAN_DESKTOP_CAPTURE_LINUX_X11_SCREEN_CAPTURER_X11_H_
