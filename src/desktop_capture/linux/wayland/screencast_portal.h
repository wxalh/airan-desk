...
#ifndef AIRAN_DESKTOP_CAPTURE_LINUX_WAYLAND_SCREENCAST_PORTAL_H_
#define AIRAN_DESKTOP_CAPTURE_LINUX_WAYLAND_SCREENCAST_PORTAL_H_
...
#endif  // AIRAN_DESKTOP_CAPTURE_LINUX_WAYLAND_SCREENCAST_PORTAL_H_
