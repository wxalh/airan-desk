...
#ifndef AIRAN_DESKTOP_CAPTURE_LINUX_WAYLAND_SCOPED_GLIB_H_
#define AIRAN_DESKTOP_CAPTURE_LINUX_WAYLAND_SCOPED_GLIB_H_
...
#endif  // AIRAN_DESKTOP_CAPTURE_LINUX_WAYLAND_SCOPED_GLIB_H_
