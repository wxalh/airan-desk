...
#ifndef AIRAN_DESKTOP_CAPTURE_SCREEN_CAPTURE_FRAME_QUEUE_H_
#define AIRAN_DESKTOP_CAPTURE_SCREEN_CAPTURE_FRAME_QUEUE_H_
...
#endif  // AIRAN_DESKTOP_CAPTURE_SCREEN_CAPTURE_FRAME_QUEUE_H_
