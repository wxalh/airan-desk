...
#ifndef AIRAN_DESKTOP_CAPTURE_MOUSE_CURSOR_MONITOR_H_
#define AIRAN_DESKTOP_CAPTURE_MOUSE_CURSOR_MONITOR_H_
...
#endif  // AIRAN_DESKTOP_CAPTURE_MOUSE_CURSOR_MONITOR_H_
