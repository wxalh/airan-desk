...
#ifndef AIRAN_DESKTOP_CAPTURE_CROPPING_WINDOW_CAPTURER_H_
#define AIRAN_DESKTOP_CAPTURE_CROPPING_WINDOW_CAPTURER_H_
...
#endif  // AIRAN_DESKTOP_CAPTURE_CROPPING_WINDOW_CAPTURER_H_
