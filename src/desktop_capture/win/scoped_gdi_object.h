...
#ifndef AIRAN_DESKTOP_CAPTURE_WIN_SCOPED_GDI_HANDLE_H_
#define AIRAN_DESKTOP_CAPTURE_WIN_SCOPED_GDI_HANDLE_H_
...
#endif  // AIRAN_DESKTOP_CAPTURE_WIN_SCOPED_GDI_HANDLE_H_
