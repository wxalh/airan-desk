...
#ifndef AIRAN_DESKTOP_CAPTURE_WIN_DXGI_TEXTURE_STAGING_H_
#define AIRAN_DESKTOP_CAPTURE_WIN_DXGI_TEXTURE_STAGING_H_
...
#endif  // AIRAN_DESKTOP_CAPTURE_WIN_DXGI_TEXTURE_STAGING_H_
