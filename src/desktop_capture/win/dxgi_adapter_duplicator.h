...
#ifndef AIRAN_DESKTOP_CAPTURE_WIN_DXGI_ADAPTER_DUPLICATOR_H_
#define AIRAN_DESKTOP_CAPTURE_WIN_DXGI_ADAPTER_DUPLICATOR_H_
...
#endif  // AIRAN_DESKTOP_CAPTURE_WIN_DXGI_ADAPTER_DUPLICATOR_H_
