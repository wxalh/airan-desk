...
#ifndef AIRAN_DESKTOP_CAPTURE_WIN_DXGI_OUTPUT_DUPLICATOR_H_
#define AIRAN_DESKTOP_CAPTURE_WIN_DXGI_OUTPUT_DUPLICATOR_H_
...
// video card. ? of functions in this class is thread-safe.
class DxgiOutputDuplicator {
 ...
 private:
  ...
  bool EmitAiranNativeFrame(
      const Microsoft::WRL::ComPtr<IDXGIResource>& resource,
...
#endif  // AIRAN_DESKTOP_CAPTURE_WIN_DXGI_OUTPUT_DUPLICATOR_H_
