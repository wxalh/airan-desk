...
#ifndef AIRAN_DESKTOP_CAPTURE_WIN_WGC_CAPTURE_SESSION_H_
#define AIRAN_DESKTOP_CAPTURE_WIN_WGC_CAPTURE_SESSION_H_
...
class WgcCaptureSession final {
 ...
 private:
  ...
  bool EmitAiranNativeFrame(Microsoft::WRL::ComPtr<ID3D11Texture2D> texture,
                            int width,
                            int height,
                            int64_t timestamp_us);
  HRESULT RecreateFramePoolForSize(
  ...
  bool airan_native_frame_emitted_ = false;
  bool airan_has_native_frame_ = false;
...
#endif  // AIRAN_DESKTOP_CAPTURE_WIN_WGC_CAPTURE_SESSION_H_
