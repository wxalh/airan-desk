...
#ifndef AIRAN_DESKTOP_CAPTURE_WIN_DISPLAY_CONFIGURATION_MONITOR_H_
#define AIRAN_DESKTOP_CAPTURE_WIN_DISPLAY_CONFIGURATION_MONITOR_H_
...
#endif  // AIRAN_DESKTOP_CAPTURE_WIN_DISPLAY_CONFIGURATION_MONITOR_H_
