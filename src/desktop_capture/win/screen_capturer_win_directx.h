...
#ifndef AIRAN_DESKTOP_CAPTURE_WIN_SCREEN_CAPTURER_WIN_DIRECTX_H_
#define AIRAN_DESKTOP_CAPTURE_WIN_SCREEN_CAPTURER_WIN_DIRECTX_H_
...
class RTC_EXPORT ScreenCapturerWinDirectx : public DesktopCapturer {
 ...
 private:
  ...
  bool dxgi_native_gpu_disabled_logged_ = false;
  SourceId current_screen_id_ = kInvalidScreenId;
};

}  // namespace airan::desktop_capture

#endif  // AIRAN_DESKTOP_CAPTURE_WIN_SCREEN_CAPTURER_WIN_DIRECTX_H_
