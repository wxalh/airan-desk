...
#ifndef AIRAN_DESKTOP_CAPTURE_WIN_WGC_CAPTURE_SOURCE_H_
#define AIRAN_DESKTOP_CAPTURE_WIN_WGC_CAPTURE_SOURCE_H_
...
#endif  // AIRAN_DESKTOP_CAPTURE_WIN_WGC_CAPTURE_SOURCE_H_
