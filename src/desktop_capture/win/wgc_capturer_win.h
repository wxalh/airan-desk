...
#ifndef AIRAN_DESKTOP_CAPTURE_WIN_WGC_CAPTURER_WIN_H_
#define AIRAN_DESKTOP_CAPTURE_WIN_WGC_CAPTURER_WIN_H_
...
class WgcCapturerWin : public DesktopCapturer {
 ...
 private:
  ...
  airan::media::AiranCaptureCallback* airan_capture_callback_ = nullptr;
...
#endif  // AIRAN_DESKTOP_CAPTURE_WIN_WGC_CAPTURER_WIN_H_
