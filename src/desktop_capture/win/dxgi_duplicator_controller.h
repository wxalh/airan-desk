...
#ifndef AIRAN_DESKTOP_CAPTURE_WIN_DXGI_DUPLICATOR_CONTROLLER_H_
#define AIRAN_DESKTOP_CAPTURE_WIN_DXGI_DUPLICATOR_CONTROLLER_H_
...
#include "desktop_capture/win/display_configuration_monitor.h"
...
class RTC_EXPORT DxgiDuplicatorController {
 public:
  ...
  // |SharedDesktopFrame|.
  Result DuplicateMonitor(DxgiFrame* frame,
                          int monitor_id,
 ...
 private:
  ...
  Result DoDuplicate(DxgiFrame* frame,
                     int monitor_id,
                     airan::media::AiranCaptureCallback* callback);
...
#endif  // AIRAN_DESKTOP_CAPTURE_WIN_DXGI_DUPLICATOR_CONTROLLER_H_
