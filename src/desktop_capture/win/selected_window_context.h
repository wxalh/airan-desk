...
#ifndef AIRAN_DESKTOP_CAPTURE_WIN_SELECTED_WINDOW_CONTEXT_H_
#define AIRAN_DESKTOP_CAPTURE_WIN_SELECTED_WINDOW_CONTEXT_H_
...
#endif  // AIRAN_DESKTOP_CAPTURE_WIN_SELECTED_WINDOW_CONTEXT_H_
