...
#ifndef AIRAN_DESKTOP_CAPTURE_WIN_WINDOW_CAPTURE_UTILS_H_
#define AIRAN_DESKTOP_CAPTURE_WIN_WINDOW_CAPTURE_UTILS_H_
...
#endif  // AIRAN_DESKTOP_CAPTURE_WIN_WINDOW_CAPTURE_UTILS_H_
