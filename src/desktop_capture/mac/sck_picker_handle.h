...
#ifndef AIRAN_DESKTOP_CAPTURE_MAC_SCK_PICKER_HANDLE_H_
#define AIRAN_DESKTOP_CAPTURE_MAC_SCK_PICKER_HANDLE_H_
...
#endif  // AIRAN_DESKTOP_CAPTURE_MAC_SCK_PICKER_HANDLE_H_
