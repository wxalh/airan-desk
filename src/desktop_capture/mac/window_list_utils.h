...
#ifndef AIRAN_DESKTOP_CAPTURE_MAC_WINDOW_LIST_UTILS_H_
#define AIRAN_DESKTOP_CAPTURE_MAC_WINDOW_LIST_UTILS_H_
...
#endif  // AIRAN_DESKTOP_CAPTURE_MAC_WINDOW_LIST_UTILS_H_
