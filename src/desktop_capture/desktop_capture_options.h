 ...
 */
#ifndef AIRAN_DESKTOP_CAPTURE_DESKTOP_CAPTURE_OPTIONS_H_
#define AIRAN_DESKTOP_CAPTURE_DESKTOP_CAPTURE_OPTIONS_H_
...
class RTC_EXPORT DesktopCaptureOptions {
 public:
  ...
  bool allow_dxgi_native_gpu_frames() const {
    return allow_dxgi_native_gpu_frames_;
  }
  void set_allow_dxgi_native_gpu_frames(bool allow) {
    allow_dxgi_native_gpu_frames_ = allow;
  }
 ...
 private:
  ...
  bool allow_dxgi_native_gpu_frames_ = true;
...
#endif  // AIRAN_DESKTOP_CAPTURE_DESKTOP_CAPTURE_OPTIONS_H_
