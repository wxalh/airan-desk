...
#ifndef AIRAN_DESKTOP_CAPTURE_CROPPED_DESKTOP_FRAME_H_
#define AIRAN_DESKTOP_CAPTURE_CROPPED_DESKTOP_FRAME_H_
...
#endif  // AIRAN_DESKTOP_CAPTURE_CROPPED_DESKTOP_FRAME_H_
