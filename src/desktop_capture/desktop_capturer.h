...
#ifndef AIRAN_DESKTOP_CAPTURE_DESKTOP_CAPTURER_H_
#define AIRAN_DESKTOP_CAPTURE_DESKTOP_CAPTURER_H_
...
#include "desktop_capture/desktop_capture_metadata.h"
...
class RTC_EXPORT DesktopCapturer {
 public:
  ...
  // Airan modification: delivers native GPU or CPU frame descriptors from the
  // WebRTC-derived fork without forcing native frames through DesktopFrame.
  virtual void SetAiranCaptureCallback(
...
#endif  // AIRAN_DESKTOP_CAPTURE_DESKTOP_CAPTURER_H_
