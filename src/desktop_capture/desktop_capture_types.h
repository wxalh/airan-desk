...
#ifndef AIRAN_DESKTOP_CAPTURE_DESKTOP_CAPTURE_TYPES_H_
#define AIRAN_DESKTOP_CAPTURE_DESKTOP_CAPTURE_TYPES_H_
...
constexpr uint32_t kSecureDesktopCapturerWin = CreateFourCC('S', 'E', 'C', 'R');
...
#endif  // AIRAN_DESKTOP_CAPTURE_DESKTOP_CAPTURE_TYPES_H_
