...
#ifndef AIRAN_DESKTOP_CAPTURE_FULL_SCREEN_WINDOW_DETECTOR_H_
#define AIRAN_DESKTOP_CAPTURE_FULL_SCREEN_WINDOW_DETECTOR_H_
...
#endif  // AIRAN_DESKTOP_CAPTURE_FULL_SCREEN_WINDOW_DETECTOR_H_
