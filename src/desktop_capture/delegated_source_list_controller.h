...
#ifndef AIRAN_DESKTOP_CAPTURE_DELEGATED_SOURCE_LIST_CONTROLLER_H_
#define AIRAN_DESKTOP_CAPTURE_DELEGATED_SOURCE_LIST_CONTROLLER_H_
...
#endif  // AIRAN_DESKTOP_CAPTURE_DELEGATED_SOURCE_LIST_CONTROLLER_H_
