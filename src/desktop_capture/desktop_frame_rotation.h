...
#ifndef AIRAN_DESKTOP_CAPTURE_DESKTOP_FRAME_ROTATION_H_
#define AIRAN_DESKTOP_CAPTURE_DESKTOP_FRAME_ROTATION_H_
...
#endif  // AIRAN_DESKTOP_CAPTURE_DESKTOP_FRAME_ROTATION_H_
